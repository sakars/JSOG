...
//   {
//     this->type =
//         std::set<Type>{Type::ARRAY, Type::BOOLEAN, Type::INTEGER,
//         Type::NULL_,
...
//     properties =
//         std::map<std::string,
//                  std::variant<JSONPointer,
//                  std::reference_wrapper<Schema>>>{};
...
// std::optional<Draft07::SchemaInternals::Type>
// Draft07::SchemaInternals::stringToType(const std::string &s)
// {
...
//     {
//       const auto &items =
//       std::get<std::vector<std::reference_wrapper<Schema>>>(
//           schema.items.value());
//       arrStruct += "  std::tuple<";
//       for (auto &item : items)
//       {
...
//   arrStruct += "static std::optional<Array> create(const nlohmann::json
//   &json);\n";
...
//   objectStruct += "static std::optional<Object> create(const nlohmann::json
//   &json);\n";
...
//   // Add the factory function
//   definition += "std::optional<" + getTypeName() + "> create(const
//   nlohmann::json &json) {\n"; for (auto &type : types)
//   {
...
//   definition += "std::optional<Object> Object::create(const nlohmann::json
//   &json) {\n";
...
//       std::get<std::reference_wrapper<Schema>>(schema).get().getIdentifier().value();
...
//   definition += "std::optional<Array> Array::create(const nlohmann::json
