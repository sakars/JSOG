...
//   {
//     std::cout << key.toString().value_or("INVALID_URI") << ": " <<
//     value->json.dump(1) << std::endl;
//   }
...
//   for (const auto &[key, value] : index)
//   {
//     std::cout << key.toString().value_or("Unknown") << ": " <<
//     value->json.dump(1) << std::endl;
//   }
...
//     const auto hasJson = [](const std::vector<std::unique_ptr<Schema>>
//     &schemas,
